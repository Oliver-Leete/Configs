...
myKeys n =
  [ ("<XF86MonBrightnessDown>", spawn "/home/oleete/.config/bin/brightness -dec 5"),
    ...
    ("M-<Return>", bindFirst [kt "launch --type=window --cwd=current", l $ upPointer $ spawn myTerminal]),
    ...
    ("M-<Left>", bindFirst [nv "NavigateTabPrev", kt "action previous_tab", l (P.sendKey (controlMask .|. shiftMask) xK_Tab)]),
    ("M-<Right>", bindFirst [nv "NavigateTabNext", kt "action next_tab", l (P.sendKey controlMask xK_Tab)]),
