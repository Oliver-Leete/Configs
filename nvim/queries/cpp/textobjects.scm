...
(field_declaration
  type: (enum_specifier)
  default_value: (initializer_list) @function.inner) @function.outer
...
(template_declaration
  (struct_specifier) @function.outer) @function.outer.start

(template_declaration
  (class_specifier) @function.outer) @function.outer.start
