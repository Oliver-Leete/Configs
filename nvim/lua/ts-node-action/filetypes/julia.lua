...
return {
    ...
    matrix_expression = matrix_toggle_multiline,
    ...
    short_function_definition = julia_func_long,
    function_expression = func_exp,
    compound_statement = begin_to_par,
    parenthesized_expression = par_to_begin,
    call_expression = toggle_do,
}
