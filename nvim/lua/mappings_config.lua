...
xnoremap("<leader>.", "<cmd>Telescope lsp_range_code_actions theme=get_cursor<CR>", "Code Actions")
    ...
    nnoremap("<leader>fm", "<cmd>Telescope media_files<cr>", "Images (and other media)")
    ...
    nnoremap("<leader>fs", function() require'telescope.builtin'.symbols{sources={'julia'}}end, "Insert Symbols")
