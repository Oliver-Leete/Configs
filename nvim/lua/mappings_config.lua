...
xnoremap("<leader>.", "<cmd>Telescope lsp_range_code_actions theme=get_cursor<CR>", "Code Actions")
    ...
    nnoremap("<leader>le", ":PerfPickEvent<CR>")
    nnoremap("<leader>la", ":PerfAnnotate<CR>")
    nnoremap("<leader>lf", ":PerfAnnotateFunction<CR>")
    xnoremap("<leader>la", ":PerfAnnotateSelection<CR>")
    nnoremap("<leader>lt", ":PerfToggleAnnotations<CR>")
    nnoremap("<leader>lh", ":PerfHottestLines<CR>")
    nnoremap("<leader>ls", ":PerfHottestSymbols<CR>")
    nnoremap("<leader>lc", ":PerfHottestCallersFunction<CR>")
    xnoremap("<leader>lc", ":PerfHottestCallersSelection<CR>")
        mapxName.name("<leader>lo", "Open Profile Data")
        nnoremap("<leader>lof", ":PerfLoadFlat<CR>")
        nnoremap("<leader>log", ":PerfLoadCallGraph<CR>")
        nnoremap("<leader>loo", ":PerfLoadFlameGraph<CR>")
    ...
    nnoremap("<leader>cd", function() require('refactoring').debug.printf({})end, "Printf")
    xnoremap("<leader>cd", function() require('refactoring').debug.print_var({})end, "Print Var")
    nnoremap("<leader>cq", function() require('refactoring').debug.cleanup({})end, "Cleanup")
    ...
    mapxName.name("<leader>h", "Terminal")
    nnoremap("<leader>ht", "<cmd>silent !kittyPersistent normterm<cr>", "Normal Terminal")
    nnoremap("<leader>hi", [[<cmd>silent exe "!kittyrepl replterm " . b:replCommand<cr>]], "REPL Terminal")
    nnoremap("<leader>hd", [[<cmd>silent exe "!kittyPersistent debugterm " . b:debugCommand<cr>]], "Debug Terminal")
    nnoremap("<leader>hm", "<cmd>silent !kittyPersistent maketerm<cr>", "Building Terminal")
    ...
    nnoremap("<leader>jj", [[<cmd>silent exe "!kittyPersistent debugterm " . b:debugCommand<cr>]], "Debug Terminal")
