...
xnoremap("<leader>.", "<cmd>Telescope lsp_range_code_actions theme=get_cursor<CR>", "Code Actions")
    ...
    nnoremap("<leader>qt", [[<cmd>!nvrTab -q $(kitty @ get-text --match title:normterm --extent last_visited_cmd_output | psub)<cr>]], "Fetch Errors From Term")
    nnoremap("<leader>qi", [[<cmd>!nvrTab -q $(kitty @ get-text --match title:replterm --extent last_visited_cmd_output | psub)<cr>]], "Fetch Errors From REPL")
    nnoremap("<leader>qm", [[<cmd>!kitty @ get-text --match title:maketerm --extent last_cmd_output | nvrTab -q /tmp/n-quickfix$()<cr>]], "Fetch Errors From Make")
    nnoremap("<leader>qd", [[<cmd>!nvrTab -q $(kitty @ get-text --match title:debugterm --extent last_visited_cmd_output | psub)<cr>]], "Fetch Errors From Debug")
