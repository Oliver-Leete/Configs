...
return {
    ...
    keys = {
        ...
        { "<c-r>",  function() require("dial.map").manipulate("decrement", "visual") end,               desc = "Decrement",     mode = { "v" } },
        { "g<c-a>", function() require("dial.map").manipulate("increment", "gvisual") end,              desc = "Increment (g)", mode = { "v" } },
        { "g<c-r>", function() require("dial.map").manipulate("decrement", "gvisual") end,              desc = "Decrement (g)", mode = { "v" } },
        { "<c-f>",  function() require("dial.map").manipulate("increment", "normal", "cycle_case") end, desc = "Cycle case" },
        { "<c-f>",  function() require("dial.map").manipulate("increment", "visual", "cycle_case") end, desc = "Cycle case",    mode = { "v" } },
    ...
    opts = function()
        ...
        local word_augends = vim.tbl_map(
            function(word_cycle)
        ...
        local symbol_augends = vim.tbl_map(
            function(symbol_cycle)
                return augend.constant.new({ elements = symbol_cycle, word = false, cyclic = true })
            end,
            symbol_cycles
        )
        ...
        return {
            groups = {
                default = default,
                cycle_case = {
                    augend.case.new({ types = { "PascalCase", "camelCase", "snake_case", "kebab-case", "SCREAMING_SNAKE_CASE" }, cyclic = true })
                }
            },
            dials_by_ft = {
                default = default,
