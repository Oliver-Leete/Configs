...
Map({ "x", "o" }, "anW", ":<c-u>call v:lua.mapped_targets(v:count, 'W', 'aW')<cr>")
Map({ "x", "o" }, "an$w", ":<c-u>call v:lua.mapped_targets(v:count, '$w', 'a$w')<cr>")
Map({ "x", "o" }, "anp", ":<c-u>call v:lua.paragraph_targets(v:count, 1)<cr>")
Map({ "x", "o" }, "anc", ":<c-u>call v:lua.git_target(v:count, 'true')<cr>")
Map({ "x", "o" }, "ani", ":<c-u>call v:lua.ts_target(v:count, '@block.outer')<cr>")
...
Map({ "x", "o" }, "aNw", ":<c-u>call v:lua.mapped_targets_back(v:count, 'b', 'ge', 'aw')<cr>")
Map({ "x", "o" }, "aNW", ":<c-u>call v:lua.mapped_targets_back(v:count, 'B', 'gE', 'aW')<cr>")
Map({ "x", "o" }, "aN$w", ":<c-u>call v:lua.mapped_targets_back(v:count, '$ge', '$b', 'a$w')<cr>")
Map({ "x", "o" }, "aNp", ":<c-u>call v:lua.paragraph_targets_back(v:count, 1, 1)<cr>")
Map({ "x", "o" }, "aNc", ":<c-u>call v:lua.git_target(v:count, 'false')<cr>")
Map({ "x", "o" }, "aNi", ":<c-u>call v:lua.ts_target(v:count, '@block.outer', 1)<cr>")
Map({ "x", "o" }, "aN,", ":<c-u>call v:lua.ts_target(v:count, '@parameter.outer', 1)<cr>")
Map({ "x", "o" }, "aNs", ":<c-u>call v:lua.ts_target(v:count, '@function.outer', 1)<cr>")
...
Map({ "x", "o" }, "inW", ":<c-u>call v:lua.mapped_targets(v:count, 'W', 'iW')<cr>")
Map({ "x", "o" }, "in$w", ":<c-u>call v:lua.mapped_targets(v:count, '$w', 'i$w')<cr>")
Map({ "x", "o" }, "inp", ":<c-u>call v:lua.paragraph_targets(v:count)<cr>")
Map({ "x", "o" }, "inc", ":<c-u>call v:lua.git_target(v:count, 'true')<cr>")
Map({ "x", "o" }, "ini", ":<c-u>call v:lua.ts_target(v:count, '@block.inner')<cr>")
...
Map({ "x", "o" }, "iNw", ":<c-u>call v:lua.mapped_targets_back(v:count, 'b', 'ge', 'iw')<cr>")
Map({ "x", "o" }, "iNW", ":<c-u>call v:lua.mapped_targets_back(v:count, 'B', 'gE', 'iW')<cr>")
Map({ "x", "o" }, "iN$w", ":<c-u>call v:lua.mapped_targets_back(v:count, '$ge', '$b', 'i$w')<cr>")
Map({ "x", "o" }, "iNp", ":<c-u>call v:lua.paragraph_targets_back(v:count, 1)<cr>")
Map({ "x", "o" }, "iNc", ":<c-u>call v:lua.git_target(v:count, 'false')<cr>")
Map({ "x", "o" }, "iNi", ":<c-u>call v:lua.ts_target(v:count, '@block.inner', 1)<cr>")
Map({ "x", "o" }, "iN,", ":<c-u>call v:lua.ts_target(v:count, '@parameter.inner', 1)<cr>")
Map({ "x", "o" }, "iNs", ":<c-u>call v:lua.ts_target(v:count, '@function.inner', 1)<cr>")
