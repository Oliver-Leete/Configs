...
Map({ "n", "x", "o" }, "[S", "<cmd>call v:lua.markGoCentre(v:count, 'TSTextobjectGotoPrevioutEnd @function.outer', 'S')<cr>")
...
Map({ "n", "x", "o" }, "]S", "<cmd>call v:lua.markGoCentre(v:count, 'TSTextobjectGotoNextEnd @function.outer', 'S')<cr>")
...
Map({ "n", "x", "o" }, "[O", "<cmd>call v:lua.markGoCentre(v:count, 'TSTextobjectGotoPreviousEnd @block.outer', 'O')<cr>")
...
Map({ "n", "x", "o" }, "]O", "<cmd>call v:lua.markGoCentre(v:count, 'TSTextobjectGotoNextEnd @block.outer', 'O')<cr>")
...
Map({ "n", "x", "o" }, "[P", "<cmd>call v:lua.markGoCentre(v:count, 'call v:lua.paragraph_end_jump_back(v:count)', 'P')<cr>")
...
Map({ "n", "x", "o" }, "]p", "<cmd>call v:lua.markGoCentre(v:count, 'norm! }', 'p')<cr>")
Map({ "n", "x", "o" }, "]P", "<cmd>call v:lua.markGoCentre(v:count, 'call v:lua.paragraph_end_jump(v:count)', 'P')<cr>")
