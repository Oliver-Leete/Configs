...
require("which-key").register({
	...
	["["] = {
		...
		["["] = { "Section" },
		["]"] = { "Section (end)" },
        O = {"<cmd>TSTextobjectGotoNextEnd @class.outer<cr>", "Class"},
        F = {"<cmd>TSTextobjectGotoNextEnd @function.outer<cr>", "Function"},
        A = {"<cmd>TSTextobjectGotoNextEnd @parameter.inner<cr>", "Parameter"},
        I = {"<cmd>TSTextobjectGotoNextEnd @conditional.inner<cr>", "Conditional"},
        C = {"<cmd>TSTextobjectGotoNextEnd @comment.outer<cr>", "Comment"},
        L = {"<cmd>TSTextobjectGotoNextEnd @loop.outer<cr>", "Loop"},
        B = {"<cmd>TSTextobjectGotoNextEnd @block.outer<cr>", "Block"},
        o = {"<cmd>TSTextobjectGotoNextStart @class.outer<cr>", "Class"},
        f = {"<cmd>TSTextobjectGotoNextStart @function.outer<cr>", "Function"},
        a = {"<cmd>TSTextobjectGotoNextStart @parameter.inner<cr>", "Parameter"},
        i = {"<cmd>TSTextobjectGotoNextStart @conditional.inner<cr>", "Conditional"},
        c = {"<cmd>TSTextobjectGotoNextStart @comment.outer<cr>", "Comment"},
        l = {"<cmd>TSTextobjectGotoNextStart @loop.outer<cr>", "Loop"},
	...
	["]"] = {
		...
		["["] = { "Section (end)" },
		["]"] = { "Section" },
        o = {"<cmd>TSTextobjectGotoPreviousStart @class.outer<cr>", "Class"},
        f = {"<cmd>TSTextobjectGotoPreviousStart @function.outer<cr>", "Function"},
        a = {"<cmd>TSTextobjectGotoPreviousStart @parameter.inner<cr>", "Parameter"},
        i = {"<cmd>TSTextobjectGotoPreviousStart @conditional.inner<cr>", "Conditional"},
        c = {"<cmd>TSTextobjectGotoPreviousStart @comment.outer<cr>", "Comment"},
        l = {"<cmd>TSTextobjectGotoPreviousStart @loop.outer<cr>", "Loop"},
        b = {"<cmd>TSTextobjectGotoPreviousStart @block.outer<cr>", "Block"},
        O = {"<cmd>TSTextobjectGotoPreviousEnd @class.outer<cr>", "Class"},
        F = {"<cmd>TSTextobjectGotoPreviousEnd @function.outer<cr>", "Function"},
        A = {"<cmd>TSTextobjectGotoPreviousEnd @parameter.inner<cr>", "Parameter"},
        I = {"<cmd>TSTextobjectGotoPreviousEnd @conditional.inner<cr>", "Conditional"},
        C = {"<cmd>TSTextobjectGotoPreviousEnd @comment.outer<cr>", "Comment"},
        L = {"<cmd>TSTextobjectGotoPreviousEnd @loop.outer<cr>", "Loop"},
