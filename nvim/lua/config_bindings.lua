...
require("which-key").register({
	...
	["<leader>"] = {
		...
		w = {
			...
			["<left>"]  = { "<c-w>H", "Move Far Left" },
			["<down>"]  = { "<c-w>J", "Move Far Down" },
			["<up>"]    = { "<c-w>K", "Move Far Up" },
			["<right>"] = { "<c-w>L", "Move Far Right" },
			H = { "<cmd>lua require('swap-buffers').swap_buffers('h')<cr>", "Swap Left" },
			J = { "<cmd>lua require('swap-buffers').swap_buffers('j')<cr>", "Swap Down" },
			K = { "<cmd>lua require('swap-buffers').swap_buffers('k')<cr>", "Swap Up" },
			L = { "<cmd>lua require('swap-buffers').swap_buffers('l')<cr>", "Swap Right" },
