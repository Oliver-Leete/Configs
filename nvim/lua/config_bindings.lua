...
require("which-key").register({
	...
	["["] = {
		...
		Q = { "<cmd>try <bar> cpfile <bar> catch /E553/ <bar> clast <bar> endtry<cr>zz<cmd>let g:dirJumps='Q'<cr>", "QuickFix File" },
		q = { "<cmd>try <bar> cprevious <bar> catch /E553/ <bar> clast <bar> endtry<cr>zz<cmd>let g:dirJumps='q'<cr>", "QuickFix Entry" },
		h = { "Hunk" },
		s = { "[szz<cmd>let g:dirJumps='s'<cr>", "Spelling Mistake" },
		["]"] = { "[]zz<cmd>let g:dirJumps=']'<cr>", "Section", noremap = false },
		["*"] = { "[#zz<cmd>let g:dirJumps='*'<cr>", "Function Call", noremap = false },
		o = { "<cmd>TSTextobjectGotoPreviousStart @class.outer<cr>zz<cmd>let g:dirJumps='o'<cr>", "Class" },
		f = { "<cmd>TSTextobjectGotoPreviousStart @function.outer<cr>zz<cmd>let g:dirJumps='f'<cr>", "Function" },
		[","] = { "<cmd>TSTextobjectGotoPreviousStart @parameter.inner<cr>zz<cmd>let g:dirJumps=','<cr>", "Parameter" },
		c = { "<cmd>TSTextobjectGotoPreviousStart @conditional.inner<cr>zz<cmd>let g:dirJumps='c'<cr>", "Conditional" },
		C = { "<cmd>TSTextobjectGotoPreviousStart @comment.outer<cr>zz<cmd>let g:dirJumps='C'<cr>", "Comment" },
		l = { "<cmd>TSTextobjectGotoPreviousStart @loop.outer<cr>zz<cmd>let g:dirJumps='l'<cr>", "Loop" },
		b = { "<cmd>TSTextobjectGotoPreviousStart @block.outer<cr>zz<cmd>let g:dirJumps='b'<cr>", "Block" },
		O = { "<cmd>TSTextobjectGotoPreviousEnd @class.outer<cr>zz<cmd>let g:dirJumps='O'<cr>", "Class" },
		F = { "<cmd>TSTextobjectGotoPreviousEnd @function.outer<cr>zz<cmd>let g:dirJumps='F'<cr>", "Function" },
		["<"] = { "<cmd>TSTextobjectGotoPreviousEnd @parameter.inner<cr>zz<cmd>let g:dirJumps='<'<cr>", "Parameter" },
		L = { "<cmd>TSTextobjectGotoPreviousEnd @loop.outer<cr>zz<cmd>let g:dirJumps='L'<cr>", "Loop" },
		B = { "<cmd>TSTextobjectGotoPreviousEnd @block.outer<cr>zz<cmd>let g:dirJumps='B'<cr>", "Block" },
	},
	["]"] = {
		name = "Forward Leader",
		["]"] = { "v:lua.jump_repeat(']')", "Repeat Last", expr=true, noremap = false},
		Q = { "<cmd>try <bar> cnfile <bar> catch /E553/ <bar> cfirst <bar> endtry<cr>zz<cmd>let g:dirJumps='Q'<cr>", "QuickFix File" },
		q = { "<cmd>try <bar> cnext <bar> catch /E553/ <bar> cfirst <bar> endtry<cr>zz<cmd>let g:dirJumps='q'<cr>", "QuickFix Entry" },
		h = { "Hunk" },
		s = { "]szz<cmd>let g:dirJumps='s'<cr>", "Spelling Mistake" },
		["["] = { "][zz<cmd>let g:dirJumps='['<cr>", "Section End", noremap = false },
		["*"] = { "]#zz", "Function Call<cmd>let g:dirJumps='*'<cr>", noremap = false },
		o = { "<cmd>TSTextobjectGotoNextStart @class.outer<cr>zz<cmd>let g:dirJumps='o'<cr>", "Class" },
		f = { "<cmd>TSTextobjectGotoNextStart @function.outer<cr>zz<cmd>let g:dirJumps='f'<cr>", "Function" },
		[","] = { "<cmd>TSTextobjectGotoNextStart @parameter.inner<cr>zz<cmd>let g:dirJumps=','<cr>", "Parameter" },
		c = { "<cmd>TSTextobjectGotoNextStart @conditional.inner<cr>zz<cmd>let g:dirJumps='c'<cr>", "Conditional" },
		C = { "<cmd>TSTextobjectGotoNextStart @comment.outer<cr>zz<cmd>let g:dirJumps='C'<cr>", "Comment" },
		l = { "<cmd>TSTextobjectGotoNextStart @loop.outer<cr>zz<cmd>let g:dirJumps='l'<cr>", "Loop" },
		b = { "<cmd>TSTextobjectGotoNextStart @block.outer<cr>zz<cmd>let g:dirJumps='b'<cr>", "Block" },
		O = { "<cmd>TSTextobjectGotoNextEnd @class.outer<cr>zz<cmd>let g:dirJumps='O'<cr>", "Class" },
		F = { "<cmd>TSTextobjectGotoNextEnd @function.outer<cr>zz<cmd>let g:dirJumps='F'<cr>", "Function" },
		["<"] = { "<cmd>TSTextobjectGotoNextEnd @parameter.inner<cr>zz<cmd>let g:dirJumps='<'<cr>", "Parameter" },
		L = { "<cmd>TSTextobjectGotoNextEnd @loop.outer<cr>zz<cmd>let g:dirJumps='L'<cr>", "Loop" },
		B = { "<cmd>TSTextobjectGotoNextEnd @block.outer<cr>zz<cmd>let g:dirJumps='B'<cr>", "Block" },
	},
	["<localleader>"] = {
		name = "Local Leader",
	},
...
function _G.jump_repeat(direction)
    jump = vim.api.nvim_get_var("dirJumps")
    print(direction .. jump)
    return replace_keycodes(direction .. jump .. "zz")
end
